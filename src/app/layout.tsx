...
export const metadata: Metadata = {
  title: "BrewCraft Coffee - Artisan Roasted Coffee Beans",
  description: "Premium coffee beans sourced from sustainable farms and roasted to perfection. Experience exceptional flavor in every cup with BrewCraft Coffee.",
  keywords: "coffee beans, artisan roasted, specialty coffee, sustainable coffee, premium coffee, coffee shop",
  metadataBase: new URL("https://brewcraftcoffee.com"),
  alternates: {
    canonical: "https://brewcraftcoffee.com"
  },
  openGraph: {
    title: "BrewCraft Coffee - Artisan Roasted Coffee Beans",
    description: "Premium coffee beans sourced from sustainable farms and roasted to perfection. Experience exceptional flavor in every cup.",
    url: "https://brewcraftcoffee.com",
    siteName: "BrewCraft Coffee",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763474232922-4cqla99l.jpg",
        alt: "BrewCraft Coffee - Premium coffee experience"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "BrewCraft Coffee - Artisan Roasted Coffee Beans",
    description: "Premium coffee beans sourced from sustainable farms and roasted to perfection.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763474232922-4cqla99l.jpg"]
  },
  robots: {
    index: true,
    follow: true
